...
public class MainFrame extends JFrame {
    ...
    private static final int TOP_FIELD_DEFAULT_COLUMNS = 15;
    ...
    private final JTextField textFieldToP;
...
// Подписи полей
        ...
        final JLabel labelToP = new JLabel("Порт");
// Поля ввода имени пользователя и адреса получателя
        textFieldFrom = new JTextField(FROM_FIELD_DEFAULT_COLUMNS);
        textFieldTo = new JTextField(TO_FIELD_DEFAULT_COLUMNS);
        textFieldToP = new JTextField(TOP_FIELD_DEFAULT_COLUMNS);
...
// Компоновка элементов панели "Сообщение"
        ...
        textAreaIncoming.setText("Port= "+String.valueOf(SERVER_PORT)+"\n");
...
// Создаем сокет для соединения
            final Socket socket
                    = new Socket(destinationAddress, Integer.parseInt(textFieldToP.getText()));
